...
module.exports = {
  activate() {
    ...
    this.subscriptions.add( atom.config.observe( _STRINGS.BASECONFIG,    ( presets ) => initEngine(presets)));
    this.subscriptions.add( atom.config.observe( _STRINGS.GRAMMARSCOPES, ( scopes  ) => {
